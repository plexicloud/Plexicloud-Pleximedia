			...
			<div class="video-entry-jt-tabs-module" style="<?php if ($thumbnail_size=='small') echo "width:92px;"; elseif ($thumbnail_size=='medium') echo "width:290px;"; elseif ($thumbnail_size=='large') echo "width:154px;";?>">
				<div class="v120WideEntry-jt-tabs-module">
					...
					<div id="video-from-jt-tabs-module">
						<?php echo _VIDEOINFO_AUTHOR ?>:<span class="video-username-jt-tabs-module"> <a href="<?php echo JRoute::_("index.php?option=com_jomtube&view=videos&type=member&user_id=" . $item->user_id) ?>"><?php echo jomtube::showShortAuthor($item->username)?></a></span>
					</div>
					<?php endif;?>
					<!--## VIDEO HITS COUNTER ##-->
